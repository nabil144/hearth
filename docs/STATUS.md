...
- Watch plays the chapter-4 film from the app bundle (`web/shorts/greek-04-poc.mp4`, 33 MB, faststart). The phone does not need this Linux box. Exit is top right. The embedded player owns pause and seek. LAN serve is a fallback only. The Met stills and the beat player are unchanged.
