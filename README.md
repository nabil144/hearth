...
The repo holds the plan, the mockups, and a phase-1 web player with three Greek chapters written. It is a POC, not a product. The plan says not to open Xcode until the shorts move.
